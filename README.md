...
| 손익분기점 도출 | 10년간 누적 비용 교차 시점 (년 단위) |
...
2. 연봉, 자산, 월 지출, 통근 거리, 희망 차량 가격 입력
3. 결과 페이지에서 자가용(월 약 87만원) vs 대중교통(월 약 17만원) 비교 확인
4. 손익분기점 차트로 10년간 누적 비용 추이 확인
...
```
감가상각  = 차량가격 × 감가상각률 (정률법: 1년차 20%, 2년차 15%, ...)
유류비    = (편도거리 × 2 × 주당횟수 × 52주) ÷ 연비(12.5km/L) × 유가(1,650원/L)
보험료    = 차량가격 × 3.5% (min 60만원, max 200만원)
자동차세  = 가격대별 30~65만원
정비비    = 연 80만원
주차비    = 월 12만원 × 12
기타      = 월 5만원 × 12
